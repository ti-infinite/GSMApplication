...
export default function DashboardShell({ items, brand, locale, userName, children }: Props) {
  const [open, setOpen] = useState(true)

  // useLayoutEffect runs before browser paint — prevents the open→close flash on mount
  useLayoutEffect(() => {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background">
      ...
      <Sidebar items={items} brand={brand} locale={locale} open={open} />
