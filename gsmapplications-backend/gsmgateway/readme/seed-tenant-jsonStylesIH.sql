SELECT * from dbo.Tenants where CompanyId = 'IH001'
...
SET JsonStyles = N'
{
  ...
  "meta": {
    ...
    "initials": "IH",
    "defaultLocale": "en",
    "logo": "https://res.cloudinary.com/drfof7eot/image/upload/IconoInfinite_pfdcp9",
    "tagline": {
      "en": "Agricultural Management Platform in USA ",
      "es": "Plataforma de Gestión Agrícola en Estados Unidos"
    }
  }
}'
